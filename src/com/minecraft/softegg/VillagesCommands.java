...
public class VillagesCommands extends VillageBase implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if(cmd.getName().equalsIgnoreCase("villageinvite")) {
            ...
            SendMessage(p, gK("villageinvite", village).replaceAll("%p%", sender.getName()));
        ...
        if(cmd.getName().equalsIgnoreCase("villagetop")) {
            ...
            SendMessage(cs, ChatDefault + "Top Villages: ");
            if(top != null) {
                SendMessage(cs, ChatImportant + "#1: " + ChatImportant + top.getName());
            }
            if(sec != null) {
                SendMessage(cs, ChatImportant + "#2: " + ChatImportant + sec.getName());
            }
            if(thr != null) {
                SendMessage(cs, ChatImportant + "#3: " + ChatImportant + thr.getName());
            }
